...
class RegrasRecomendacao(KnowledgeEngine):
    ...
    @Rule(AND(Fact(tipoPreco='2'), Fact(tipoRam='2'), Fact(tipoMultiChip='sim')))
    def escolhaMotorolaMotoE6i(self):
        self.celular = "Motorola Moto E6i"
        self.precodoCelular = "R$ 699,00"

    @Rule(AND(Fact(tipoPreco='2'), Fact(tipoRam='4'), Fact(capacidade='64'), Fact(camFrontal='sim'), Fact(marca='lg')))
    def escolhaLGK62(self):
        self.celular = "LG K62"
        self.precodoCelular = "R$ 1.049,00"

    @Rule(AND(Fact(tipoPreco='2'), Fact(tipoRam='4'), Fact(capacidade='128'), Fact(marca='motorola')))
    ...
    @Rule(AND(Fact(tipoPreco='2'), Fact(tipoRam='4'), Fact(capacidade='64'), Fact(camFrontal='13'), Fact(marca='samsung')))
    def escolhaSamsungGalaxyA21s(self):
        self.celular = "Samsung Galaxy A21s"
        self.precodoCelular = "R$ 1.435,00"

    @Rule(AND(Fact(tipoPreco='2'), Fact(tipoRam='4'), Fact(capacidade='128'), Fact(marca='samsung')))
    def escolhaSamsungGalaxyA31(self):
        self.celular = "Samsung Galaxy A31"
        self.precodoCelular = "R$ 1.619,00"

    @Rule(AND(Fact(tipoPreco='2'), Fact(tipoRam='2'), Fact(tipoMultiChip='nao')))
    def escolhaIPhone6(self):
        self.celular = "iPhone 6S"
        self.precodoCelular = "R$ 1.749,00"
    
    @Rule(AND(Fact(tipoPreco='2'), Fact(tipoRam='4'), Fact(capacidade='64'), Fact(camPrincipal='12')))
    def escolhaZenFone5(self):
        self.celular = "ZenFone 5"
        self.precodoCelular = "R$ 1.799,00"
    
    @Rule(AND(Fact(tipoPreco='25'), Fact(tipoRam='6'), Fact(capacidade='128'), Fact(marca='lg')))
    def escolhaLGVelvet(self):
        self.celular = "LG Velvet"
        self.precodoCelular = "R$ 2.299,00"

    @Rule(AND(Fact(tipoPreco='25'), Fact(tipoRam='6'), Fact(capacidade='128'), Fact(marca='xiaomi')))
    ...
    @Rule(AND(Fact(tipoPreco='5'), Fact(tipoRam='8'), Fact(camFrontal='64')))
    def escolhaZenFone7Pro(self):
        self.camcelular = "ZenFone 7 Pro"
        self.precodoCelular = "R$ 6.497,00"
    
    @Rule(AND(Fact(tipoPreco='5'), Fact(tipoRam='8'), Fact(camPrincipal='20')))
